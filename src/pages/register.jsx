...
export default function RegisterPage(){
    ...
    const handleSubmit = () => {
        ...
        if (!formData.password) alert("Please enter Password");
            ...
            axios
                .post(`http://localhost:3002/api/publicApi/registerUser`, {
                    name: formData.name,
    ...
    return(
        <>
            <Header/>
            <section className="text-gray-600  body-font bg-cover bg-[url('/gym1.jpg')] object-cover object-center">
                <div className="container px-10 py-16 mx-auto flex flex-wrap items-center ">
                    ...
                    <div
                        className="lg:w-2/6 md:w-1/2 text-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 bg-gray-900 shadow-2xl relative  bg-opacity-50 backdrop-blur-lg ">
