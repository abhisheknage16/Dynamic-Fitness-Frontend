...
export default function login() {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:3002/api/profileApi/getMyProfile`)
            .then((response) => {
    ...
    const handleSubmit = () => {
        ...
        if (!formData.password) alert("Please enter Password");
            ...
            axios
                .post(`http://localhost:3002/api/profileApi/updateMyProfile`, {
                    name: formData.name,
    ...
    const handleLogout = () => {
        axios
            .get(`http://localhost:3002/api/publicApi/logout`)
            .then((response) => {
                router.push('/');
            })
            .catch((err) => {
    ...
    return (
        <>
            <Header/>
            <section className="text-gray-600 body-font relative bg-cover bg-[url('/gym1.jpg')] object-center object-fill">
                <div className="container px-5 py-12 mx-auto justify-center">
                    ...
                    <div className="lg:w-1/2 md:w-2/3 mx-auto">
                        <div
                            className="relative lg:w-4/6 md:w-1/2 bg-gray-800 bg-opacity-50 backdrop-blur-lg text-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 shadow-2xl">
                            <h2 className="text-lime-500 text-2xl font-bold font-mono decoration-wavy title-font mb-5 uppercase">
                                update profile</h2>
